...
<html lang="en" dir="ltr">
  ...
  <body class="w-full h-full bg-blue-200 md:bg-blue-300">
    ...
    <form method="post" class="px-4 rounded mx-auto max-w-3xl w-full  inputs space-y-6">
      ...
      <a href="client_records.php" name="button" class="mt-5 border-red-900 bg-blue-300 font-bold border-2 p-2 rounded-md">Cancelar</a>
      <button type="submit" formaction="../crud/clientlist_update.php" name="button" class="mt-5 border-green-900 bg-blue-300 font-bold border-2 p-2 rounded-md">Confirmar Actualización</button>
